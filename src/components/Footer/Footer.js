...
//             <Image src="/images/logo/logo.svg" alt="Logo" width={140} height={30} className="w-36" />
//             <span className="text-2xl font-semibold text-gray-900 dark:text-white">{title}</span>
//           </Link>
//         </div>
...
//             )}
//             <div>
//               <h3 className="text-xl font-bold text-gray-900 dark:text-white">More</h3>
//               <ul className="mt-4 space-y-2">
//                 <li>
//                   <Link href="/feed.xml" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary">
//                     RSS
//                   </Link>
//                 </li>
//                 <li>
//                   <Link href="/sitemap.xml" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary">
//                     Sitemap
//                   </Link>
//                 </li>
//               </ul>
...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-primary dark:bg-primary/5 border border-gray-100 dark:border-gray-800 bg-opacity-5 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="mb-8 flex flex-wrap justify-center md:justify-start items-center gap-6 grayscale hover:grayscale-0 transition">
                  <Image src="/images/partner/aws-partner.webp" width={60} height={60} alt="React" />
                  {/* <Image src="/images/common/dark (2).svg" width={60} height={60} alt="AWS" />
                  <Image src="/images/error/maintenance-dark.svg" width={60} height={60} alt="WordPress" /> */}
                </div>

                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Empowering Businesses with Scalable Web Solutions, Seamless Hosting, and Cutting-Edge SaaS Innovation.
                </p>
                <div className="flex items-center">
                  ...
                  <Link
                    href="https://twitter.com/zenithx_official"
                    target="_blank"
                    aria-label="social-link"
                    className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md bg-primary bg-opacity-10 text-black dark:text-white duration-300 hover:bg-opacity-100 hover:text-white ml-3"
                  >
                  ...
                  {/* <Link
                    href="https://www.youtube.com/zenithx.official"
                    aria-label="social-link"
                    className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md bg-primary bg-opacity-10 text-black dark:text-white duration-300 hover:bg-opacity-100 hover:text-white ml-3"
                  >
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Pages</h2>
                <ul>
                  <li>
                    <Link
                      href="/posts/page/1"
                  ...
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Pricing</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>About</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Contact</span>
                    </Link>
                  </li>
                </ul>
              </div>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Services</h2>
                <ul>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Web & App Development</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Digital Marketing</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                  ...
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Social Media Marketing</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                      href="/service/backlinks-buildings"
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Backlinks Buildings</span>
                    </Link>
                  </li>
                </ul>
              </div>
                ...
                <ul>
                  {/* <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Open Support Ticket</span>
                    </Link>
                  </li> */}
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Terms of Conditions</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block flex items-center text-base font-medium text-body-color hover:text-primary"
                    >
                      <IoChevronForward className="mr-1 text-primary" /> <span>Privacy Policy</span>
                    </Link>
                  </li>
                  <li>
                    <Link
