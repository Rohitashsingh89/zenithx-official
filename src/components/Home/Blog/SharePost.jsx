...
const SharePost = () => {
  ...
  return (
    <>
      ...
      {/* Twitter / X */}
      <Link
        href={`https://twitter.com/intent/tweet?url=${fullUrl}&text=${shareText}`}
        target="_blank"
        rel="noopener noreferrer"
        className="ml-3 mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md bg-primary bg-opacity-10 text-black dark:text-white duration-300 hover:bg-opacity-100 hover:text-white"
