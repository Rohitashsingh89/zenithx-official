        ...
        <div className="w-full">
          <div className="wow fadeInUp rounded-md bg-white dark:bg-black lg:px-5 xl:px-8" data-wow-delay=".1s">
            <div className={`wow fadeInUp w-full mx-auto text-center`} data-wow-delay=".1s">
              <h2 className="mb-4 text-3xl font-bold !leading-tight text-black dark:text-white sm:text-4xl md:text-[45px] max-w-2xl mx-auto">
                Redefining Digital Presence with{' '}
                <span className="text-gradient">Unmatched Performance and Reliability</span>
              </h2>
